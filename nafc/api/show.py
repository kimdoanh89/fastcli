...
@click.option(
    "--structured/--no-structrued", default=False,
    help="present structured data", required=False)
@click.option(
    "--table/--no-table", default=False,
    help="present data in a table", required=False)
