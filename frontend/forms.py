...
class MonitorForm(FlaskForm):
    device = SelectField("Select Device")
...
def validate_name(self, name):
    ...
    if name:
        raise ValidationError(
            "That Project name is taken. Please choose a different one."
        )
...
def validate_config_file(self, config_file):
    ...
    if config_file:
        raise ValidationError(
            "Project with this config file is exist. Please choose a different one."
        )
